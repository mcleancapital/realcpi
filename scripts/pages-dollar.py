...
# Paths for the files
excel_file = './data/dollar.xlsx'
html_template = './dollar/index.html'
output_html = './dollar/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">US Dollar Index</span>:</b> {latest_volume:,} ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
