...
# File paths
excel_file = './data/us-home-prices-change.xlsx'
html_template = './us-home-prices-change/index.html'
output_html = './us-home-prices-change/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">US Home Prices Change</span>:</b> {latest_volume:,}%",
    html_content,
    flags=re.DOTALL
)
