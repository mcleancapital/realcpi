...
# Paths for the files
excel_file = './data/cash-us.xlsx'
html_template = './cash-us/index.html'
output_html = './cash-us/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">Cash use in the US (as a % of all transactions)</span>:</b> {latest_volume:.2f}% ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
