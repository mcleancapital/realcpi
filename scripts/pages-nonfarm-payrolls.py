...
html_template = './nonfarm-payrolls/index.html'
output_html = './nonfarm-payrolls/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">US Nonfarm Payrolls</span>:</b> {latest_volume:.2f}K ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
