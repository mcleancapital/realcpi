...
def update_sp500_html(html_file, excel_file, output_file):
    try:
        ...
        formatted_change = f"({'+' if most_recent_change >= 0 else ''}{most_recent_change:,.1f}% vs last year)"
        ...
        data_marker = "<!-- Household Debt Service -->"
        ...
        sp500_marker = '<a class=box href="/household-debt-service">'
