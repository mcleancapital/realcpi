...
# Paths for the files
excel_file = './data/sp-500-pe.xlsx'
html_template = './s-p-500-pe-ratio/index.html'
output_html = './s-p-500-pe-ratio/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">S&P 500 P/E Ratio</span>:</b> {latest_volume:,} ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
