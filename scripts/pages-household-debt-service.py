...
html_template = './household-debt-service/index.html'
output_html = './household-debt-service/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">Household Debt Service as a % of Disposable Income</span>:</b> {latest_volume:.2f}% ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
