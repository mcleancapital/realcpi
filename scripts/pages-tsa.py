...
# Paths for the files
excel_file = './data/tsa.xlsx'
html_template = './tsa-checkpoint/index.html'
output_html = './tsa-checkpoint/index.html'
...
dates_since_reference = (data["Date"] - datetime(1970, 01, 01)).dt.days.tolist()
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">US Airports Passenger Volume</span>:</b> {latest_volume:,} ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
