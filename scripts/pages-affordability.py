...
# Paths for the files
excel_file = './data/affordability.xlsx'
html_template = './affordability/index.html'
output_html = './affordability/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">US Housing Affordability Index</span>:</b> {latest_volume:.2f} ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
