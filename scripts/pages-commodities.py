...
# Paths for the files
excel_file = './data/commodities.xlsx'
html_template = './commodities/index.html'
output_html = './commodities/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">Commodities Inflation</span>:</b> {latest_volume:.2f} ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
