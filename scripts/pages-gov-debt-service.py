...
html_template = './gov-debt-service/index.html'
output_html = './gov-debt-service/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">Federal Outlays: Interest as Percent of Gross Domestic Product</span>:</b> {latest_volume:.2f}% ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
