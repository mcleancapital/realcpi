...
# Paths for the files
excel_file = './data/ppi.xlsx'
html_template = './ppi/index.html'
output_html = './ppi/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">US Producer Price Index</span>:</b> {latest_volume:.2f} ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
