...
EXCEL_FILE_PATH = './data/grocery-sales.xlsx'

# YCharts URL and headers
URL = "https://ycharts.com/indicators/us_grocery_store_sales"
HEADERS = {
...
def fetch_recent_sales_data(url):
    """Fetch the most recent grocery sales data from YCharts."""
    try:
...
def update_excel(file_path, recent_date, recent_value):
    """Update the Excel file with the new grocery sales data and compute % change vs last year."""
    try:
...
if __name__ == "__main__":
    date_str, value = fetch_recent_sales_data(URL)
