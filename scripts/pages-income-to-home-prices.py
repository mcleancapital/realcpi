...
html_template = './income-to-home-prices/index.html'
output_html = './income-to-home-prices/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">US Home Prices / Household Income</span>:</b> {latest_volume:,} ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
