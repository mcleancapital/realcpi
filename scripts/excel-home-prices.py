...
EXCEL_FILE_PATH = './data/us-home-prices.xlsx'

# URL and headers
URL = "https://tradingeconomics.com/united-states/single-family-home-prices"
HEADERS = {
...
def fetch_recent_lei_data(url):
    """Fetch the 9th numeric value and the date from the 5th <td> element."""
    try:
        ...
        # Extract the 9th numeric value for the LEI
        numeric_values = []
