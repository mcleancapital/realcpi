...
# Paths for the files
excel_file = './data/sp-500-sales-growth.xlsx'
html_template = './s-p-500-sales-growth/index.html'
output_html = './s-p-500-sales-growth/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">S&P 500 Sales Growth</span>:</b> {latest_volume:.2f}% ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
