...
# Paths for the files
excel_file = './data/lending-hours.xlsx'
html_template = './lending-hours/index.html'
output_html = './lending-hours/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">US Financial Activity</span>:</b> {latest_volume:,}M ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
