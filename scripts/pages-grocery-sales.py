...
# Paths for the files
excel_file = './data/grocery-sales.xlsx'
html_template = './grocery-sales/index.html'
output_html = './grocery-sales/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">US Apparel Sales</span>:</b> {latest_volume:,}B ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
