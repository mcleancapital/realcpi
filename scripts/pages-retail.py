...
# Paths for the files
excel_file = './data/retail-growth.xlsx'
html_template = './retail/index.html'
output_html = './retail/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">Retail Sales Growth</span>:</b> {latest_volume:.2f}%"
