...
html_template = './us-deficit/index.html'
output_html = './us-deficit/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">US Federal Surplus or Deficit / Nominal GDP</span>:</b> {latest_volume:.2f}%"
