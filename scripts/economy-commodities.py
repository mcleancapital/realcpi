...
def update_sp500_html(html_file, excel_file, output_file):
    try:
        ...
        # Step 4: Locate the specific section for Commodities
        print("Step 4: Updating the specific section for Commodities...")
        sp500_marker = '<a class=box href="/commodities">'
