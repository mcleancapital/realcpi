...
EXCEL_FILE_PATH = './data/nonfarm-payrolls.xlsx'

# URL and headers
URL = "https://ycharts.com/indicators/us_nonfarm_payrolls_mom"
HEADERS = {
...
def fetch_recent_cpi_data(url):
    ...
    try:
        ...
        recent_value = float(parts[0].replace("K", "")  # Extract TSI value
