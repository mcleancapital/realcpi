...
# Paths for the files
excel_file = './data/consumer-sentiment.xlsx'
html_template = './sentiment/index.html'
output_html = './sentiment/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">US Consumer Sentiment</span>:</b> {latest_volume:,} ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
