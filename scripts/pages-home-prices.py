...
# Paths for the files
excel_file = './data/us-home-prices.xlsx'
html_template = './us-home-prices/index.html'
output_html = './us-home-prices/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">US Home Prices</span>:</b> {latest_volume:,} ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
