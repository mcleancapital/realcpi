...
# Paths for the files
excel_file = './data/savings.xlsx'
html_template = './savings/index.html'
output_html = './savings/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">US Personal Saving Rate</span>:</b> {latest_volume:.2f}% ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
