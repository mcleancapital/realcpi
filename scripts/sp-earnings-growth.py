...
# Paths for the files
excel_file = './data/sp-500-earnings-growth.xlsx'
html_template = './s-p-500-earnings-growth/index.html'
output_html = './s-p-500-earnings-growth/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">S&P 500 Earnings Growth</span>:</b> {latest_volume:.2f}% ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
