...
EXCEL_FILE_PATH = './data/affordability.xlsx'

# YCharts URL for US TSI Freight Index
URL = "https://ycharts.com/indicators/us_fixed_affordability_index"
HEADERS = {
...
def fetch_recent_freight_data(url):
    """Fetch the most recent Housing Affordability data from YCharts."""
    try:
