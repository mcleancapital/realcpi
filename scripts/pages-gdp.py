...
# Paths for the files
excel_file = './data/us-gdp-growth-rate.xlsx'
html_template = './us-gdp-growth-rate/index.html'
output_html = './us-gdp-growth-rate/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">US GDP Growth Rate</span>:</b> {latest_volume:.2f}%"
