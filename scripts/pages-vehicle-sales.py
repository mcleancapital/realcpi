...
# Paths for the files
excel_file = './data/vehicle-sales.xlsx'
html_template = './vehicle-sales/index.html'
output_html = './vehicle-sales/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">US Vehicle Sales Volume (12-month units)</span>:</b> {latest_volume:,}M units ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
