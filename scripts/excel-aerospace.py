...
SERIES_ID = "IPG3364S"  # Aerospace

# Output Excel file
EXCEL_FILE = "./data/aerospace.xlsx"
...
# Main logic
try:
    m2_data = get_fred_monthly_data(SERIES_ID, API_KEY)

    # Get the most recent date
    latest_date = max(m2_data.keys())
    latest_value = m2_data[latest_date]
    ...
    try:
        ...
        wb = Workbook()
        sheet = wb.active
        sheet.append(["Date", "M2 (Billions USD)"])
