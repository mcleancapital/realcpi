...
html_content = html_content.replace("-1.8%", returns[1])   # Materials
html_content = html_content.replace("15.6%", returns[2])  # Industrials
html_content = html_content.replace("29.1%", returns[3])   # Cons. Discr.
html_content = html_content.replace("12.0%", returns[5])   # Cons. Staples
html_content = html_content.replace("0.9%", returns[4])   # Health Care
html_content = html_content.replace("28.4%", returns[6])  # Financials
html_content = html_content.replace("35.7%", returns[7])   # Technology
