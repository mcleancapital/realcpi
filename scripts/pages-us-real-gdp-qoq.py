...
# Paths for the files
excel_file = './data/us-real-gdp-growth-qoq.xlsx'
html_template = './us-real-gdp-growth-qoq/index.html'
output_html = './us-real-gdp-growth-qoq/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">US Real GDP Growth Rate QoQ</span>:</b> {latest_volume:.2f}%"
