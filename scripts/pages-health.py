...
# Paths for the files
excel_file = './data/healthcare.xlsx'
html_template = './healthcare/index.html'
output_html = './healthcare/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">US Personal Healthcare expenditures</span>:</b> {latest_volume:,}T ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
