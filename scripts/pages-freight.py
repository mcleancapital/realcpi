...
# Paths for the files
excel_file = './data/freight.xlsx'
html_template = './freight/index.html'
output_html = './freight/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">US Transportation Services Index</span>:</b> {latest_volume:.2f} ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
